...
mobileprovision_name="4e149e6a-4636-4f86-b2c2-0f4ea38484e1"
# 被mobileprovision_name包含的签名证书
ADHOCCODE_SIGN_IDENTITY=""
# method，打包的方式。方式分别为 development, ad-hoc, app-store, enterprise 。必填 
# 可以在开发者网站中查询ProvisioningProfile的type属性获取
method="ad-hoc"
...
echo "--------------------Menthuguan debug archive0--------------------"

# 判断编译的项目类型是workspace还是project
if $is_workspace ; then
# 编译前清理工程
echo "--------------------Menthuguan debug archive1--------------------"
...
xcodebuild archive -workspace ${workspace_name}.xcworkspace \
                   ...
                   PROVISIONING_PROFILE="${mobileprovision_name}" \
                   PRODUCT_BUNDLE_IDENTIFIER="${bundle_identifier}"

else
echo "--------------------Menthuguan debug archive2--------------------"
# 编译前清理工程
